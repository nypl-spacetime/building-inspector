...
This project works with GeoJSON files generated by the [NYPL Map Vectorizer]. The specific files for the NYPL is found in the [/public/files](public/files/) folder.
