class CreateLayers < ActiveRecord::Migration
  def change
    ...
    # Layer.create!(id: 859, name: 'New York, 1857', description: 'Maps of the city of New York', tilejson: 'https://s3.amazonaws.com/maptiles.nypl.org/859/859spec.json', year: 1857)
