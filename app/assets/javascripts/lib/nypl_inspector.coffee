class @Inspector
  ...
  endGame:() ->
    # no map found, die
    msg = "<strong>No unprocessed data found for this task</strong><br />Good news! This seems to be complete. Maybe <a href='/random?not=#{@options.task}' class='mobile'>try another task</a>?"
